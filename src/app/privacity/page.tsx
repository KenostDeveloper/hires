...
import PrivacityComponent from "./PrivacityComponent";
import styles from "./privacity.module.css";

export const metadata = {
  title: "HiRes Studio — Политика конфиденциальности",
  description:
    "Студия записи подкастов и интервью в Санкт-Петербурге Hires Studio. Мы предоставляем услуги аренды студии подкастов, аренда интерьерной студии и аренду студии с цветным фоном. Так же проводим съемки подкаста с оператором, съёмки видео-интервью, проводим прямые эфиры на стриминговые площадки.",
  icons: {
    icon: "/logo.svg",
  },
};
    ...
    <div className={styles.main}>
      ...
      <div className="container">
        ...
        <p>
          ...
          предпринимаемые МЕРЕНКОВ ДЕНИС ИГОРЕВИЧ (далее — Оператор).
        </p>
        <p>
        ...
        <p>
          ...
          Оператор может получить о посетителях веб-сайта https://hires.studio
        </p>
        ...
        <p>
          ...
          в сети интернет по сетевому адресу https://hires.studio.
        </p>
        <p>
        ...
        <p>
          2.10. Пользователь — любой посетитель веб-сайта https://hires.studio.
        </p>
        <p>
        ...
        <p>6.1. Цель обработки - информирование Пользователя посредством отправки электронных писем</p>

        <p>6.2. Персональные данные:
        ...
        <p>6.3. Правовые основания:
        <br/>• Уставные (учредительные) документы Оператора
        <br/>• Договоры, заключаемые между оператором и субъектом персональных данных</p>

        <p>6.4. Виды обработки персональных данных:
        <br/>• Сбор, запись, систематизация, накопление, хранение, уничтожение и обезличивание персональных данных
        <br/>• Отправка информационных писем на адрес электронной почты</p>
        ...
        <p>8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора info@hires.studio с пометкой «Актуализация персональных данных».</p>
        <p>8.4. Срок обработки персональных данных определяется достижением целей, для которых были собраны персональные данные, если иной срок не предусмотрен договором или действующим законодательством. Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора info@hires.studio с пометкой «Отзыв согласия на обработку персональных данных».</p>
        ...
        <h4>12. Конфиденциальность персональных данных</h4>
        <p>12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты info@hires.studio.</p>
        ...
        <p>12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://hires.studio/privacity.</p>
      </div>
    </div>
  );
}
