            ...
            <SwiperSlide>
                <div className={styles.slider}>
                    ...
                    <div className={styles.sliderText}>
                        ...
                        <div onClick={() => setModal(true)} className={styles.bronButton}>ЗАБРОНИРОВАТЬ <img src="/lineButton.svg" alt="" /></div>
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide>
                <div className={styles.slider}>
                    ...
                    <div className={styles.sliderText}>
                        <h3>Аренда студии с цветным фоном</h3>
                        <p>Комфортная фото и видеостудия с цветными фонами для записи разговорных видео на одном из наших цветных фонов с профессиональным видео-светом.</p>
                        <p>Из цветов есть: голубой, фиолетовый, белый, желтый фон. В студии проведена аудиоподготовка, практически НЕТ эха как в других студиях, висят звукопоглощающие панели.</p>
                        <p>Аренда студии без оператора включает 2 постоянных видео-света Amaran 100 и 200. Дополнительно можно арендовать 2 цветные RGB-палки и суфлер на всю съемку (не важно, сколько часов вы берете)</p>
