      ...
      <div className={styles.main}>
          ...
          {portfolio.map((port: any) => (
            <ModalPhoto isIframe={true} key={port.id} active={port.isModal} setActive={handlePortfolioClick} id={port.id}>
              <iframe width="100%" height="100%" src={port.iframeLink} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
            </ModalPhoto>
          ))}
        ...
        <div className={styles.kenost}>
          <div className="container">
            ...
            {portfilioList == 0? 
              <div className={styles.clients}>
                <div className={styles.clients__el} onClick={() => setPortfolioList(1)}>
                    <img src="/portfolio/list/1.png" alt="Подкасты" />
                    <p>Подкасты</p>
                </div>
                <div className={styles.clients__el} onClick={() => setPortfolioList(2)}>
                    <img src="/portfolio/list/2.png" alt="Прямые эфиры" />
                    <p>Прямые эфиры</p>
                </div>
                <div className={styles.clients__el} onClick={() => setPortfolioList(3)}>
                    <img src="/portfolio/list/3.png" alt="Интервью" />
                    <p>Интервью</p>
                </div>
                <div className={styles.clients__el} onClick={() => setPortfolioList(4)}>
                    <img src="/portfolio/list/4.png" alt="Разговорные видео" />
            ...
            portfilioList == 1?
            <div>
                <img className={styles.ClientBack} src="/back.svg" alt="Назад" onClick={() => setPortfolioList(0)}/>
