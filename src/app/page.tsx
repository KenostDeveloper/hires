...
export default function Home() {
  ...
  const [price, setPrice] = useState([
    {
      ...
      card: [
        ...
        {
          id: 2,
          name: "Каждый последующий час аренды студии подкастов (при аренде свыше 3х часов)",
          price: "1500",
        },
        {
          id: 3,
        ...
        {
          id: 5,
          name: "Каждый последующий час записи видео-подкаста с оператором (при аренде свыше 3х часов)",
          price: "4000",
        },
        {
          id: 6,
  ...
  function handlePortfolioClick(id: number) {
    const nextShapes = portfolio.map((portfolio) => {
      if (portfolio.id != id) {
        // No change
        return portfolio;
      } else {
  ...
  function handlePriceClick(id: number) {
    const nextShapes = price.map((price) => {
      if (price.id != id) {
        // No change
        return price;
      } else {
    ...
    <div className={styles.main}>
      ...
      <div className={styles.lines}>
        <svg
          width="1300"
          height="664"
          viewBox="0 0 1300 664"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            d="M1425.73 141.303L-199.258 1.51347M1372.37 401.897L-252.614 262.107M1319.02 662.491L-305.969 522.701"
            stroke="url(#paint0_linear_81_81)"
            strokeWidth="3"
          />
          <defs>
            <linearGradient
              id="paint0_linear_81_81"
              x1="6.32093"
              y1="-81.2149"
              x2="2025.51"
              y2="759.411"
        ...
        <div className="container">
          ...
          <div className={styles.turnkey} id="podcast">
            <div className={styles.lines2}>
                <svg width="1300" height="2693" viewBox="0 0 1300 2693" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M-296.132 2691.9L1639.49 518.538M-423.233 2433.48L1512.39 260.113M-550.334 2175.05L1385.29 1.68836" stroke="url(#paint0_linear_367_286)" stroke-width="3"/>
                <defs>
                <linearGradient id="paint0_linear_367_286" x1="1380.02" y1="190.527" x2="-2242.82" y2="1732.41" gradientUnits="userSpaceOnUse">
          ...
          <div>
                <SwiperPortfolio portfolio={portfolio} handlePortfolioClick={handlePortfolioClick} />
          ...
          <div className={styles.contact}>
            ...
            <div className={styles.contactRight}>
              <Link href="#">+7 (999) 666-75-75</Link>
              <div className={styles.contactSocials}>
                    <Link href="#" className={styles.contactSocialsMobile}>
                      +7 (999) 666-75-75
                    </Link>
                    ...
                    <Link target="_blank" href="https://t.me/hiresst">
                ...
                <Link target="_blank" href="https://yandex.ru/maps/2/saint-petersburg/?from=api-maps&ll=30.319483%2C59.920375&mode=routes&origin=jsapi_2_1_79&rtext=~59.920380%2C30.319740&rtt=mt&ruri=~&z=17" className={styles.bronButton}>ПОСТРОИТЬ МАРШРУТ <img src="/lineButton.svg" alt="" /></Link>
            </div>
          </div>
