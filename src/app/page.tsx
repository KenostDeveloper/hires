    ...
    <div className={styles.main}>
      ...
      <div className={`container ${styles.container}`}>
        ...
        <div className={styles.mainLeft}>
          ...
          <Link href="#" className={styles.mainButtonTwo}>
            ПРАЙС
          </Link>
        ...
        <div className="container">
          ...
          <div className={styles.fact}>
            <div className={`${styles.fact__el} ${styles.fact__center}`}>
              ...
              <p>
                Удобное <Link href="#">расположение</Link>
              </p>
            </div>
            <div className={`${styles.fact__el} ${styles.fact__center}`}>
            ...
            <div className={styles.fact__el}>
              ...
              <p>
                Современное, качественное <Link href="#">оборудование</Link>
              </p>
            </div>
            <div className={styles.fact__el}>
              <img src="/cum.svg" alt="" />
              <p>
                ...
                <Link href="#">создания подкаста под ключ</Link>
              </p>
            </div>
          </div>
          ...
          <div className={styles.contact}>
            ...
            <div className={styles.contactRight}>
              ...
              <div className={styles.contactSocials}>
                ...
                <Link href="https://yandex.ru/maps/2/saint-petersburg/?from=api-maps&ll=30.319483%2C59.920375&mode=routes&origin=jsapi_2_1_79&rtext=~59.920380%2C30.319740&rtt=mt&ruri=~&z=17" className={styles.bronButton}>ПОСТРОИТЬ МАРШРУТ <img src="/lineButton.svg" alt="" /></Link>
            </div>
          </div>
        </div>
      </div>
